...
|---|---|---|---|
| HU-PDR-03 | Data model and interfaces (APIs) | done | [COMMIT_URL](https://github.com/AsolanoT/01-invoice-app/issues/9) |
| HU-ADR-03 | Document Rejected Alternatives | done | [COMMIT_URL](https://github.com/AsolanoT/01-invoice-app/issues/10) |
